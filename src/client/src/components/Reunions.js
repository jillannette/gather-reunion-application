  ...
  return (
    ...
    <Col xs={6} md={4}>
      ...
      <Card.Body>
        ...
        <Button variant="primary" href="reunionsPhotoGallery">View 2016 Gallery</Button>
      </Card.Body>
    </Card>
    </Col>
    </Row>
    ...
    <Row>
      ...
      <Card.Body>
        ...
        <Button variant="primary" href="reunionsPhotoGallery">View 2011 Gallery</Button>
    ...
    <Col xs={6} md={4}>
      ...
      <Card.Body>
        ...
        <Button variant="primary" href="reunionsPhotoGallery">View 2006 Gallery</Button>
      </Card.Body>
    </Card>
    </Col>
    <Col xs={6} md={4}>
      ...
      <Card.Body>
        ...
        <Button variant="primary" href="reunionsPhotoGallery">View 2001 Gallery</Button>
      </Card.Body>
    </Card>
    </Col>
    </Row>
    ...
    <Row>
      ...
      <Card.Body>
        ...
        <Button variant="primary" href="reunionsPhotoGallery">View 1996 Gallery</Button>
      </Card.Body>
    </Card>
    </Col>
    <Col xs={6} md={4}>
    ...
    <Col xs={6} md={4}>
      ...
      <Card.Body>
        ...
        <Button variant="primary" href="reunionsPhotoGallery">View 1986 Gallery</Button>
      </Card.Body>
    </Card>
    </Col>
    ...
    <Col xs={6} md={4}>
      ...
      <Card.Body>
        ...
        <Button variant="primary" href="reunionsPhotoGallery">View K-12 Gallery</Button>
      </Card.Body>
    </Card>
    </Col>
    </Row>
