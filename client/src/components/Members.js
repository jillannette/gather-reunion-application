                    ...
                    <Col key={member._id} s={12} md={6} lg={4} xl={4}>
                      <Card style={{ width: "20rem" }}>
                        ...
                        <Card.Body className="member-card-body">
                          ...
                          <Card.Text  style={{textAlign: "center"}}>{member.currentName}</Card.Text>
                          <Card.Title className='member-subtitles' style={{textAlign: "center"}}>({member.nameAtGraduation})</Card.Title>
                          <Card.Title className='member-subtitles' style={{textAlign: "center"}}>{member.email}</Card.Title>
                          <Card.Title className='member-subtitles' style={{textAlign: "center"}}>{member.residesIn}</Card.Title>
